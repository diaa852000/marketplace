            ...
            <Card className="w-[550px]">
                <div className="p-6">
                    ...
                    <div className="mt-3 text-center sm:mt-5 w-full">
                        <h3 className="text-muted-foreground text-xl leading-6 font-medium">Payment Successfull</h3>
                        <p className="mt-2 text-base text-muted-foreground/95">
                            Congrats to your pruchase! Plese check your email for further instructions.
                        </p>
